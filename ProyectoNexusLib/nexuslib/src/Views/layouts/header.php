    ...
    <div class="collapse navbar-collapse" id="nexusNavbar">
      ...
      <div id="liveSearchContainer" class="mx-lg-4 flex-grow-1 position-relative">
        <form action="index.php" method="get" class="search-wrapper d-flex align-items-center">
          ...
          <input type="text" id="liveSearch" name="q" class="form-control bg-dark text-white" placeholder="Busca por título, autor o ISBN...">
        </form>
        <div id="searchOverlay" class="search-results-overlay"></div>
      </div>

      <div class="d-flex align-items-center mode-switch-container mx-3">
        <span class="small text-secondary fw-bold me-2">VIRTUAL</span>
          <div class="form-check form-switch m-0 p-0 d-flex align-items-center">
            <?php 
              // Verificamos si el modo físico está activo en la sesión
              $isFisico = (isset($_SESSION['biblioteca_modo']) && $_SESSION['biblioteca_modo'] === 'fisico'); 
            ?>
        ...
        <span class="small text-secondary fw-bold ms-2">FÍSICA</span>
      </div>
